...
import { Search, FileText, Pill, Clipboard, Users, Activity, MessageSquare, ExternalLink, ShoppingCart } from 'lucide-react';
...
const INITIAL_TASKS: Task[] = [
  ...
  },
  {
    ...
    createdDate: 'October 22, 2025',
    assignedTo: 'Michael Rodriguez, MA'
  },
  {
    id: '11',
    ...
    assignedTo: 'Jessica Martinez, Front Desk'
  },
  {
    id: '12',
    ...
    taskType: 'Team Task',
    description: 'Verify insurance authorization for MRI',
    priority: 'High',
    status: 'Pending',
  ...
  },
  {
    ...
    patientMRN: 'MRN-12345',
    taskType: 'Team Task',
    description: 'Send reminder for upcoming lab work',
    priority: 'Medium',
    status: 'Pending',
    dueDate: 'October 26, 2025',
    createdDate: 'October 24, 2025',
...
export function Tasks2View({
  ...
  const [allTasks, setAllTasks] = useState<Task[]>([...INITIAL_TASKS, ...routedTasks]);

  // Update tasks when new tasks are routed
  useEffect(() => {
