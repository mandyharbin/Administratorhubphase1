      ...
      <>
        ...
        <MobileFrame>
          <div className="h-full flex flex-col bg-white">
            ...
            {/* Content */}
            <div className="flex-1 overflow-hidden flex flex-col p-4">
              <ScrollArea className="border rounded-lg p-3 mb-4 h-[380px]">
                <div className="space-y-3 text-sm">
                  <div>
                    <h4 className="font-semibold mb-1">Pre-Chat Disclaimer</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">
                      This secure messaging service is not for urgent or emergency medical situations. 
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">AI Assistant Notice</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">
                      Our AI Assistant is designed to help answer general questions and route you to the 
                      appropriate staff member. While the AI can provide general information, it cannot 
                      diagnose conditions, prescribe medications, or schedule appointments. When necessary, 
                      your message will be routed to qualified healthcare staff.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs leading-relaxed">
                      The AI Assistant responds immediately. When messages are routed to staff, you can 
                      expect a response within 2-4 hours during business hours (Monday-Friday, 8 AM - 5 PM). 
                      Messages sent outside business hours will be answered on the next business day.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs leading-relaxed">
                      All communications through this portal are encrypted and HIPAA-compliant. Your 
                      personal health information is protected and will only be shared with authorized 
                      healthcare providers involved in your care.
                    </p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Appointment Scheduling</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">
                      The AI Assistant can provide information about your existing appointments but cannot 
                      schedule, reschedule, or cancel appointments. For appointment changes, your request 
                      will be routed to our scheduling staff.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs leading-relaxed">
                      By accepting these terms, you consent to receive communications from our healthcare 
                      facility via email, SMS, push notifications, and in-app messages. You can manage 
                      your communication preferences in your account settings at any time.
                    </p>
                  </div>
                </div>
              </ScrollArea>
